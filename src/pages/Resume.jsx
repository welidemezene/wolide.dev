                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="resume-section bg-gradient-to-r from-blue-500 to-purple-600 text-white p-8 sm:p-12">
                        <div className="text-center sm:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-6 text-blue-100 w-full">
                                <span className="flex items-center w-full sm:w-auto justify-start">
                                    {/* Gmail icon */}
                                    ...
                                    <span className="break-words">woldemedihnmezene@gmail.com</span>
                                </span>
                                <span className="flex items-center w-full sm:w-auto justify-start">
                                    <svg className="w-4 h-4 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                    <span>+2519 04660160</span>
                                </span>
                            </div>
                    ...
                    <div className="p-8 sm:p-12 space-y-8">
                        ...
                        <div className="resume-section">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:space-x-6">
